...
I'm Hongsup/홍섭 and I am an AI/ML practitioner in Austin, TX. I am a Senior AI & LLM Engineer at NVIDIA, and a co-chair of the SciPy conference Proceedings Committee. I volunteer at [Texas Justice Initiative](https://texasjusticeinitiative.org/), a local criminal justice non-profit in Austin, and have volunteered previously in other organizations such as DataKind, NeurIPS, and SciPy as grant and paper reviewers. I run an in-person [ML journal club](https://austinmljournalclub.github.io/) in Austin, TX.

My background is computational neuroscience (PhD) and behavioral ecology (MSc). My general interests are AI engineering, ML Ops, AI ethics, responsible AI, and ML in hardware. Feel free to reach out to me on [Linkedin](https://www.linkedin.com/in/hongsupshin/) and check out some of my work:
